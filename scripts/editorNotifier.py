...
def main(testing=False, testing_editors=[], send_editor_emails=False):
    ...
    if not editors:
        ...
        if configProps.keys() & {'smtp.host', 'smtp.port', 'smtp.user', 'smtp.password', 'discourse.url', 
                                 'editor.thread', 'admin.name', 'admin.user', 'admin.email'}:
            messages = []
            ...
            for editor in editors:
                ...
                if send_editor_emails:
                    ...
                    editor_message['From'] = editor.get('admin_email_from', editor.get('admin_email_address', configProps['smtp.user']))
...
if __name__ == '__main__':
    ...
    main(args.testing, args.editors, send_editor_emails)
